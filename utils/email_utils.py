...
def send_appointment_confirmation(appointment):
    ...
    <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
        ...
        <p>Best regards,<br>Stylish Cuts Team</p>
    </body>
    </html>
    '''
    ...
    try:
        ...
        smtp_server = 'mail.jacksonwebdev.com'
        smtp_port = 465
        smtp_username = 'sjackson@jacksonwebdev.com'
        smtp_password = os.environ.get('SMTP_PASSWORD')  # Ensure this is set in your environment

        if not smtp_password:
            error_msg = "SMTP password is not set in environment variables"
